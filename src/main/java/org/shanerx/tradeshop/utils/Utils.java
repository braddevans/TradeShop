...
public class Utils {
    ...
    public boolean canExchange(Inventory inv, ItemStack itmOut, ItemStack itmIn) {
        ...
        for (ItemStack i : inv.getContents()) {
            ...
            else { empty += itmIn.getMaxStackSize(); }
        }
     ...
     *
     * @param chest
     *         the block holding the shop's inventory. Can be a chest, a trapped chest, a dropper, a dispenser, a hopper and a shulker box (1.9+).
     *
     * @return the sign.
     */
