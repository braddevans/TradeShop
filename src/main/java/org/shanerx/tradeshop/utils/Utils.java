...
public class Utils {
     ...
     *
     * @param inv
     *         the Inventory object representing the inventory that is subject to the transaction.
     * @param itmOut
     *         the ItemStack that is being given away
     * @param itmIn
     *         the ItemStack that is being received
     *
     ...
     *
     * @param e
     *         Event to reset the sign for
     * @param shop
     *         Shoptype enum to get header
     */
     ...
     *
     * @param e
     *         event where shop creation failed
     * @param shop
     *         Shoptype enum to get header
     * @param msg
     *         The enum constant representing the error message
     */
    ...
    /**
     * Checks whether the an inventory contains at least a certain amount of a certain material inside a specified
     * inventory.
     * <br>
     * This works with the ItemStack's durability, which represents how much a tool is broken or, in case of a block,
     * the block data.
     *
     * @param inv
     ...
     * @param amount
     *         the amount attempting to be traded
     *
     ...
     *
     * @param msg
     *         string containing Color and formatting codes.
     *
     ...
     *
     * @param chest
     *         the block holding the shop's inventory. Can be a chest, a trapped chest, a dropper, a dispenser, a hopper
     *         and a shulker box (1.9+).
     *
     * @return the sign.
     */
     ...
     *
     * @param shop
     *         the Shop object the player is trading with
     * @param playerInv
     *         the Inventory object representing the inventory that is subject to the transaction.
     * @param multiplier
     *         the multiplier for the trade
     * @param action
