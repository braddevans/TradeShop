...
public class SuccessfulTradeEvent extends PlayerInteractEvent {
     ...
     *
     * @param who
     *         The {@link org.bukkit.entity.Player} object representing the player who is attempting the trade.
     * @param cost
     *         The object representing the items which are being traded.
     * @param product
     *         The object representing the items being traded for.
     * @param shop
     *         The object representing the shop at which the trade takes place.
     * @param clickedBlock
     *         The {@link org.bukkit.block.Block} that was clicked, ie. the sign.
     * @param clickedFace
     *         The {@link org.bukkit.block.BlockFace} object representing the face of the block that was clicked.
     */
