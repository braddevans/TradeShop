...
public class PlayerShopOpenEvent extends PlayerEvent implements Cancellable {
     ...
     *
     * @param buyer
     *         The {@link org.bukkit.entity.Player} object representing the player who is performing the action.
     * @param s
     *         The {@link Shop} object which represents the player shop which is being opened.
     */
