...
public class PlayerShopDestroyEvent extends PlayerEvent implements Cancellable {
     ...
     *
     * @param p
     *         The {@link org.bukkit.entity.Player} object representing the player who is destroying the shop.
     * @param shop
     *         The {@link Shop} object which represents the shop the player is destroying.
     */
     ...
     *
     * @param destroyBlock
     *         true if the BlockBreakEvent should be cancelled.
     */
