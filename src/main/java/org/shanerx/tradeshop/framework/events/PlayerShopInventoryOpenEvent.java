...
public class PlayerShopInventoryOpenEvent extends PlayerInteractEvent implements Cancellable {
     ...
     *
     * @param p
     *         The {@link org.bukkit.entity.Player} object which represents the player who opens the shop inventory.
     * @param s
     *         The {@link Shop} object which represents the shop the player is attempting to access.
     * @param action
     *         The {@link org.bukkit.event.block.Action} enum entry which represents the action which was performed.
     * @param itm
     *         The {@link org.bukkit.inventory.ItemStack} object representing the item the player holds in their hands.
     * @param chest
     *         The chest (or other inventory-equipped block) which holds the shop inventory.
     * @param chestFace
     *         The face of the block which was clicked.
     */
